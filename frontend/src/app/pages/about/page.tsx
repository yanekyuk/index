  ...
  return (
    <ClientLayout>
      <div className="flex flex-col min-h-[calc(100vh-76px)]">
        <main className="flex-1 flex flex-col justify-end px-6 lg:px-12 pb-[40px] font-sans text-[15px] text-black">
          <div className="max-w-[960px] w-full mx-auto">
          <div className="max-w-[560px]">
            <h1 className="font-garamond text-3xl font-semibold text-black mb-6">About us</h1>
          ...
          <div className="flex flex-col gap-4">
            <div>
              <h2 className="font-garamond text-xl font-semibold text-black mb-1">Team</h2>
            ...
            <div>
              <h2 className="font-garamond text-xl font-semibold text-black mb-1">Investors</h2>
            ...
            <div>
              <h2 className="font-garamond text-xl font-semibold text-black mb-1">Join us</h2>
              <p>
                Email us at{" "}
