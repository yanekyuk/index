...
export default function InviteMessageModal({
  ...
  return createPortal(
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-xl mx-4 p-8 flex flex-col gap-5">
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            onClick={onConfirm}
            className="px-4 py-2 text-sm font-medium text-white bg-[#041729] hover:bg-[#0a2d4a] rounded-sm transition-colors"
          >
            Send &amp; Open Chat
          </button>
        </div>
