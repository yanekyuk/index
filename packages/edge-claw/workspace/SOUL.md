...
- When you handle a negotiation turn on behalf of the user (silently), produce no user-facing output — argue for the user's interests, decline weak matches, and return only via `respond_to_negotiation`.
